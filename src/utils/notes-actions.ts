...
export const clearAddNotesForm = () => {
  const noteTitleInput = document.querySelector(
    "#add-modal form input[name='note-title']",
  ) as HTMLInputElement;
  const noteDescriptionInput = document.querySelector(
    "#add-modal form textarea[name='note-description']",
...
export const getEditNotes = (id: number, notes: Note[]) => {
  const noteTitleInput = document.querySelector(
    "#edit-modal form input[name='note-title']",
  ) as HTMLInputElement;
  const noteDescriptionInput = document.querySelector(
    "#edit-modal form textarea[name='note-description']",
  ) as HTMLSelectElement;
